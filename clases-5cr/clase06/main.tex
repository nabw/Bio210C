...
\begin{frame}[fragile]{Pipes y redirecciones}
  ...
  $ cat 'out.txt' | grep "ho"
  $ # Toma la salida del primer comando, 1) la imprime y 2) la guarda en out.txt
...
\begin{frame}[noframenumbering, fragile]\frametitle{Mini ejercicios}
    ...
    \begin{enumerate}
        ...
        \item Hacer los siguientes ejercicios: 
            ...
            \end{center}
        \item Se pueden agregar funciones no lineales de parámetros. Pruebe modelos no-lineales:
    \end{enumerate}
